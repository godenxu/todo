...
;globalThis.__api = {
  ...
  mergePermissionMatrix, sameWholeObject, noteUserConflicts, USER_HEARTBEAT_KEYS, permissionMatrixPanelHTML, canSeePage, PAGES,
  get objConflicts(){return _objConflicts}, setObjConflicts(v){ _objConflicts = v; },
